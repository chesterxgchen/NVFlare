...
| Mandatory behavior | Draft | Behavior IDs cover runtime mode selection, mode-specific evidence, bounded logs, pattern matching, partial evidence, and recovery reporting. |
