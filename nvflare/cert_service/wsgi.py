...
if __name__ == "__main__":
    ...
    print()
    print("API Endpoints:")
    print("  POST /api/v1/enroll     - Enrollment (token required)")
    print("  POST /api/v1/token      - Token generation (API key required)")
    print("  GET  /api/v1/ca-cert    - Download root CA certificate")
